...
<link rel="icon" href="../ProductImg/SPFavicon.png" sizes="16x16">
        <meta charset="UTF-8">
        <title>SP IT! TM | ADD Category</title>
                        ...
                        <li class="treeview active">
                            <a href="#">
                          	...
                          	<ul class="treeview-menu">
                                ...
                                <li class="active"><a href="addcategory.jsp"><i class="fa fa-angle-double-right"></i> Add Category</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                			...
                			<div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" action="verifyAddCategory.jsp" method="post">
                                    <div class="box-body">
                                        <!-- textarea -->
                                        <div class="form-group">
                                            <label>New Category Name</label>
                                            <textarea name="CategoryType" class="form-control" rows="2" placeholder="Enter here..."></textarea>
                                        </div>
                                        <!-- textarea -->
                                    </div><!-- /.box-body -->
