...
<body>
	<%
		try{
			...
			String AddCategorysql="Insert into productcategory (CategoryType) values(?)";
   			
   			PreparedStatement AddCategorypstmt=conn.prepareStatement(AddCategorysql);
   			
   			AddCategorypstmt.setString(1, CategoryType);
			
   			int AddCategoryrec=AddCategorypstmt.executeUpdate();
