...
<body>
       	<%
       		try  {
       			...
       			deleteproductpstmt.setInt(1,Integer.parseInt(deleteproduct));
       			
       			int deleteproductrec=deleteproductpstmt.executeUpdate();
       			
       			out.println(deleteproductrec+ " record(s) deleted");
       			
       			if (deleteproductrec == 1) {
