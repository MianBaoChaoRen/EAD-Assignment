...
<title>verifyAddAdministrator</title>
...
<body>
	<%
		try{
			...
			String AddAdminsql="Insert into admin (Name, UserID, Password) values(?,?,?)";
   			
   			PreparedStatement AddAdminpstmt=conn.prepareStatement(AddAdminsql);
   			
   			AddAdminpstmt.setString(1,name);
   			AddAdminpstmt.setString(2,userid);
   			AddAdminpstmt.setString(3,password);
			
   			int AddAdminrec=AddAdminpstmt.executeUpdate();
