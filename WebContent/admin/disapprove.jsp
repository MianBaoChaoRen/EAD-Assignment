...
<body>
       	<%
       		try  {
       			...
       			String disapprovesql="UPDATE review set Approved=0, Featured=0 where CommentID=?";
       			
       			PreparedStatement disapprovepstmt=conn.prepareStatement(disapprovesql);
       			
       			disapprovepstmt.setInt(1,Integer.parseInt(disapprove));
       			
       			int disapproverec=disapprovepstmt.executeUpdate();
       			
       			out.println(disapproverec+ " record(s) deleted");
